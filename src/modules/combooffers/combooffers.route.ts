...
import {
  createComboOffersZodSchema,
  updateComboOffersZodSchema,
} from "./combooffers.zod";
...
router.post(
  "/",
  zodValidate(createComboOffersZodSchema),
  combooffersController.createComboOffers,
);
router.get("/", combooffersController.getAllComboOfferss);
router.get("/:id", combooffersController.getComboOffersById);
router.put(
  "/:id",
  zodValidate(updateComboOffersZodSchema),
  combooffersController.updateComboOffers,
);
